...
async function obtenerListaTutor() {
  const url = `https://kiddycheck-api.azurewebsites.net/api/v1/Personas/ObtenerPersonaPorTipo?id=3`;
...
async function obtenerListaDocente() {
  const url = `https://kiddycheck-api.azurewebsites.net/api/v1/Personas/ObtenerPersonaPorTipo?id=2`;
  let response = await axios.get(url, {
    headers: {
      "Content-Type": "application/json",
    },
