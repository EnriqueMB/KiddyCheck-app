...
async function ObtenerCalificacionPorBimestre() {
  ...
  try {
    const resul = await axios.get(`https://kiddycheck-api.azurewebsites.net/api/CalificacionAlumnos/ObtenerAlumnoPorIdYBimestre?id=${props.data.id}&bimestre=${String(data.bimestreACalificar)}`,)
...
async function obtenerMateria() {
  ...
  const url = `https://kiddycheck-api.azurewebsites.net/api/v1/Materias/MateriasXGrado?id=${grado}`;
...
async function GuardarCalificacion() {
  try {
    ...
    const resul = await axios.post('https://kiddycheck-api.azurewebsites.net/api/CalificacionAlumnos/AgregarCalificacion', data.guardarCalificacion)
...
async function EditarCalificacion() {
  try {
    ...
    const resul = await axios.put('https://kiddycheck-api.azurewebsites.net/api/CalificacionAlumnos/EditarCalificacion', data.calificacionEdit)
    if (resul.data.success) {
      toast.success(resul.data.message)
      data.editardialog = false
      data.calificacionEdit.calificacion = 0
...
async function EliminarCal() {
  try {
    ...
    const resul = await axios.delete(`https://kiddycheck-api.azurewebsites.net/api/CalificacionAlumnos/EliminarCalificasion?id=${data.idEliminarCal}`)
    if (resul.data.success) {
      toast.success(resul.data.message)
      data.eliminarDialog = false
      data.idEliminarCal = 0
...
async function mostrarInformacion() {
  try {
    ...
    const resul = await axios.get(`https://kiddycheck-api.azurewebsites.net/api/CalificacionAlumnos/ProbabilidadPorId?id=${props.data.id}`)
