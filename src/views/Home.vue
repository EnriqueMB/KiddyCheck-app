 ...
 export default {
  ...
  methods: {
    async AsistenciasDia() {
      let result = await axios.get('https://kiddycheck-api.azurewebsites.net/api/v1/Alumno/AsistenciasHoy')
      this.contadorDia = result.data
    },
    async AsistenciasSemanales() {
      let result = await axios.get('https://kiddycheck-api.azurewebsites.net/api/v1/Alumno/AsistenciasSemanal')
